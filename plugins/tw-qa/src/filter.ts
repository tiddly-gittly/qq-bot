...
const searchFilter = '[!is[shadow]!is[system]field:type[text/vnd.tiddlywiki]] [!is[shadow]!is[system]field:type[text/markdown]] +[search:title,text,caption,keywords:some[${query}]sort[modified]${filter}]';
